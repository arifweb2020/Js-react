...
const IterationDetails = [
    ...
    },
	{
	  ...
	  statusID: "closed",
      status: "Closed",
	  comments:"status is closed"
    },
	{
	  id:3,
      date: "24-09-2021",
      assignedTo: "Anil k Kuran",
	  statusID: "verified",
      status: "Verified",
	  comments:"verified"
    },
        ...
        <MainContainer>
            ...
            <InnerConatiner mt={6}>
                <Box p={4}>
                    ...
                    <Grid container mt={3}>
                        <Grid item xs={12}>
                            <InputHedaing>Iteration Details</InputHedaing>
                        </Grid>
                    </Grid>
                    <Grid container mt={3}>
                        <Grid item xs={3}>
                        ...
                        <Grid item xs={3}>
                            <ColumnHeading>Assigned To</ColumnHeading>
                        </Grid>
                        <Grid item xs={3}>
                            <ColumnHeading>Status</ColumnHeading>
                        </Grid>
                        <Grid item xs={3}>
                            <ColumnHeading>Comments</ColumnHeading>
                        </Grid>
                    </Grid>
                    <Grid container mt={3}>
                        <Grid item xs={12}>
                        ...
                        <Grid item xs={12}>
                            <StyledTableContainer component={Paper}>
                                <Table aria-label="customized table">
                                    ...
                                    <StyledTableBody>
                                        <StyledTableRow >
                                            <StyledTableCell align="left">sadsdf</StyledTableCell>
                                            <StyledTableCell align="left">ddfd</StyledTableCell>
                                            <StyledTableCell align="left">
                                                {/* <ReportStatusBox color={row.statusID} text={row.status} /> */}
                                                dfdfgdg
                                            </StyledTableCell>
                                            <StyledTableCell align="left">
                                                gfgfdfdh
