...
const AccountSetup = (props) => {
  ...
  const confirmAccountSetup = () => {
    ...
    console.log([dateValue.getFullYear(), mnth, day].join(""));
    let details = {
      ...
      // "currentAddress": {
      //   "address": "#145 Royal oak apartment",
      //   "state": 1,
      //   "country": 1,
      //   "pinCode": 560038
      // }
  ...
  const onEnd = () => {
    setTrimmedDataURL(signPad.toDataURL("image/svg+xml"));
  };
  const dobInfoStage = () => {
    return (
      <React.Fragment>
      ...
      <React.Fragment>
        <div className="contentWrapper">
          <div className="moveBack">
            <p className="backArrows" onClick={() => setStage("dobInfo")}>{"<"} Back</p>
          </div>
          <div className="headerSection">
          ...
          <div className="termsCondition">
            <span>
              ...
              <span className="ul" onClick={() => setStage("prefilledInfo")}>click here</span>
  ...
  const prefilledInfoStage = () => {
    return (
      <React.Fragment>
        <div className="contentWrapper">
          <div className="moveBack">
            <p className="backArrows" onClick={() => setStage("addressInfo")}>{"<"} Back</p>
          </div>
          <div className="headerSection">
            <p>
              Pre-filled information to speed up your onboarding
            </p>
          </div>
          <div>
            <button className="amfiButton">Required by AMFI</button>
          ...
          <div className="accountSetupForm">
            <form>
              ...
              <div className="form-group">
                ...
                <div>
                  <button className="btnDark">Yes</button>
                  <button className="btnLight">No</button>
                </div>
              </div>
  ...
  const depositInfoStage = () => {
    return (
      <div className="contentWrapper">
        <div className="contentText text-center">Depositing ₹1 in your account</div>
      </div>
    );
  };
  ...
  const signStage = () => {
    return (
      <React.Fragment>
        <div className="contentWrapper">
          <div className="moveBack">
            <p className="backArrows" onClick={() => setStage("bankInfo")}>{"<"} Back</p>
          </div>
          <div className="headerSection">
    ...
    <React.Fragment>
      <Loader loading={loading}>
        <div className="accountSetupWrapper">
          {["kycInfo", "verifyInfo", "depositInfo", "setUpComplete"].includes(stage) ? (
            ""
          ) : (
