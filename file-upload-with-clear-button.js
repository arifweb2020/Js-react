...
import { CheckedIcon, ClosedIcon, FileIcon, UploadIcon } from '../../../../assets/icons/feedBackIcon';
                            ...
                            <ButtonBox>
                                <button className="btn btn-cancel" onClick={() => { setFile("") || setComments("") }}>Cancel</button>
                                {
                                    file === "" ?
                                        ...
                                        : <button className="btn btn-submit btn-active" onClick={() => alert('arif')}>Submit</button>
                                }
                            </ButtonBox>
                        </Grid>
                    </Grid>
