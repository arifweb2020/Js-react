...
function CreateApproval(props) {
    ...
    const resetForm = () => {
        setProduct(dropDownData.productType.filter((ele) => ele.selected === true)[0].code) || setDate(dropDownMonth.month.filter((ele) => ele.selected === true)[0].code) || setComments("")
    }
                ...
                <Box p={4}>
                    <Grid container >
                        ...
                        <Grid item xs={12} sm={6} md={3} ml={3}>
                            ...
                            <FormControl sx={{ width: '100%' }}>
                                ...
                                >
                                    {/* {dropDownMonth.month.map((month, i) => (
                                        <StyledMenuItem value={i === 0 ? "" : i}>
                                            {month}
                                        </StyledMenuItem>
                                    ))} */}
                    ...
                    <Grid container mt={3}>
                        <Grid item xs={12} sm={6} md={5}>
                            ...
                            <FormControl sx={{ width: '100%' }}>
                                <input type="text" className="inputFiledText"
                                    value={approvalLabel.fieldsLabel.productHeadName}
                                    disabled
                                />
                            </FormControl>
                        </Grid>
                        <Grid item xs={12} sm={6} md={5} ml={3}>
                            ...
                            <FormControl sx={{ width: '100%' }}>
                                <input type="text" className="inputFiledText"
                                    value={approvalLabel.fieldsLabel.businessHeadName}
                                    disabled
                                />
                            </FormControl>
                        </Grid>
