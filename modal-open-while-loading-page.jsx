...
import { panUpdate, investmentProfile } from "../../data/dataStore";
  ...
  const confirmAmount = () => {
    ...
    investmentProfile
      .profileInvestment({
        ...
        riskType: get(props, "riskLevel", 1),
      })
      .then((data) => {
        setLoading(false)
        setCofirmPanStage(false);
        // setCompleteStage(true);
        window.location.replace(get(data, "dsta.paymentUrl", ""));
      })
      .catch((err) => {
        setLoading(false)
        getToastError(err.errorMessage);
  ...
  return (
    <Loader loading={loading}>
      <React.Fragment>
        <div className="modalContainer">
          {isDesktop ? (
            ...
            <Sheet
              ...
              isOpen={modalVisible}
              onClose={closeModal}
              snapPoints={[-60, 0.8, 0.6, 0.4, 0.2, 0]}
              initialSnap={0}
        ...
        {confirmInvestment && (
          <div className="container confirmInvestment">
            <div className="row">
              <div className="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-12">
                <p className="goBack" onClick={backEnterAmount}>{"<"} Back</p>
                <div className="heading mt-4">
                  <h4>We rounded your investment</h4>
                  <p>To accurately invest in Integrated Portfolio model</p>
                </div>
                <div className="mt-2">
                  <hr />
                </div>
                <div className="userInvest mt-4">
                  <p>You will invest</p>
                  <h3>₹50,000</h3>
                </div>
                <div className="userInvest ">
                  <p>In the following </p>
                  <h3>Integrated Portfolio</h3>
                  <span>Risk Level 3</span>
                </div>
                <div className="mt-2">
                  <hr />
                </div>
                <button className="commonButton confirmButton mt-5 mb-3">
                  Confirm investment
                </button>
              </div>
            </div>
...
export default connect(mapStateToProps)(InvestAmount);
